...
![Live Coder Agent diff showing a proposed add function and Apply selected changes](../screenshots/coder-agent-diff-20260908.png)
...
![Coder file editor retaining an unsaved draft with a remote-change conflict message](../screenshots/coder-conflict-draft-20260908.png)
...
![Live Share host with two participants and the guest cursor on a synchronized edit](../screenshots/coder-liveshare-host-20260908.png)

![Live Share guest receiving the host return edit and labeled remote cursor](../screenshots/coder-liveshare-guest-20260908.png)
